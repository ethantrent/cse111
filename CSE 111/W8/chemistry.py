...
def make_periodic_table():
    periodic_table_dict = {
        ...
        #USE MULITLINE EDIT W/ CTRL + ALT + ARROW KEYS]
        "Ac": ["Actinium",	227],
        "Ag": ["Silver",	107.8682],
...
def main():
    ...
    # Call the get_formula_name function to get the name
    # of the molecule from the known_molecules_dict.
...
def get_formula_name(formula, known_molecules_dict):
    ...
    """
    # If formula is in the known_molecules_dict:
