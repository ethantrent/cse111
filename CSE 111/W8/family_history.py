...
def print_death_age(people_dict):
    ...
    print("Name, Age at Death.")
    # For each person in the people dictionary:
    for person_key, person_list in people_dict.items(): # .items() returns all the keys and values in the dictionary
        # Separate the list into its components.
        ...
        # Print the name and age at death.
...
def print_marriages(marriages_dict, people_dict):
    ...
    Return: nothing
    """
    print("Husband, Age at Wedding, Wedding Year, Wife, Age at Wedding")
