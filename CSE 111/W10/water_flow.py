...
def pressure_loss_from_pipe(pipe_diameter, pipe_length, friction_factor, fluid_velocity):
    ...
    if abs(pipe_diameter) < 0.000001:
        raise ValueError("The diameter of the pipe cannot be zero.")
...
def main():
    try:
        ...
        diameter = float(input("Enter the diameter of the pipe from the tank to the lot (meters): "))
