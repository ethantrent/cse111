...
def main():
    # # Add exception handling code that prints a useful error message when the computer raises FileNotFoundError.
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            # Add exception handling code that prints a useful error message when the computer raises a ValueError for the percentage reduction
    ...
    # Add exception handling code that prints a useful error message when the computer raises a FileNotFoundError for the file name
